            ...
            <header className="flex h-14 items-center justify-between border-b px-4 shrink-0 bg-white z-10">
                ...
                {isAuth && (
                    <button
                        ...
                        className={`rounded-full p-2 hover:bg-blue-50 transition-colors ${activeTab === 'settings' ? 'text-blue-500 bg-blue-50' : 'text-gray-400 hover:text-blue-500'}`}
                    >
            ...
            {isAuth && (activeTab !== 'settings') && (
                <nav className="flex h-16 border-t bg-white items-center justify-around px-2 shrink-0">
                    <button
                        ...
                        className={`flex flex-col items-center gap-1 transition-colors py-2 px-4 rounded-lg ${activeTab === 'memo' ? 'text-blue-500' : 'text-gray-400 hover:text-blue-400'}`}
                    >
                    ...
                    <button
                        ...
                        className={`flex flex-col items-center gap-1 transition-colors py-2 px-4 rounded-lg ${activeTab === 'recent' ? 'text-blue-500' : 'text-gray-400 hover:text-blue-400'}`}
                    >
                    ...
                    <button
                        ...
                        className={`flex flex-col items-center gap-1 transition-colors py-2 px-4 rounded-lg ${activeTab === 'clip' ? 'text-blue-500' : 'text-gray-400 hover:text-blue-400'}`}
                    >
